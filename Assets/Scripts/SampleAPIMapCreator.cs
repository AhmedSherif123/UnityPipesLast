...
{
	[SerializeField] public ArcGISMapComponent mapComponent;
	[SerializeField] public ArcGISCameraComponent cameraComponent;
	...
	public void CreateArcGISMap()
	{
		...
		{
			if (!mapComponent.Map.Layers.Contains(pipesLayer))
			{
